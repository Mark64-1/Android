...
public class ProductActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(singleProduct != null){
            ...
            productSize.setText("이름: " + String.valueOf(singleProduct.getProductName()));
            productColor.setText("가격: " + String.valueOf(new Double(singleProduct.getProductPrice()).intValue()));
            productPrice.setText("사이즈: " + String.valueOf(new Double(singleProduct.getProductSize()).intValue()));
            productDescription.setText(Html.fromHtml("<strong>제품 소개</strong><br/>" + singleProduct.getProductDescription()));
        }
